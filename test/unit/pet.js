...
var Pet = require('../../app/models/pet');    //do not need .js ext

describe('Pet', function(){     //name of Constructor being tested
...
describe('#sleep', function(){
  it('should increase health and energy but decrease full', function(){
    ...
    expect(pet.full).to.be.within(13,17);
  });
});
...
describe('#fight', function(){
  ...
  expect(fluffy.isZombie).to.befalse;
